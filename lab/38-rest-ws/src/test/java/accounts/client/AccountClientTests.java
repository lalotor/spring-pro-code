...
public class AccountClientTests {
	...
	@Test
	public void createSameAccountTwice() {
	...
	public void addAndDeleteBeneficiary() {
		...
		Beneficiary newBeneficiary = restTemplate.getForObject(newBeneficiaryLocation.toString(), Beneficiary.class);
		...
		HttpClientErrorException httpClientErrorException = assertThrows(HttpClientErrorException.class, () -> {
			...
			restTemplate.getForObject(newBeneficiaryLocation.toString(), Beneficiary.class);
		});
